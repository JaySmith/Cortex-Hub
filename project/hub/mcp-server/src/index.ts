    ...
    "hub_skill_manifest_set",
    {
      ...
      inputSchema: {
        manifest: z
          .string()
          .describe(
            "JSON array of {role, description, required: [{name, version}], optional: [{name, version}]}",
          ),
      },
    },
    async ({ manifest }) => {
